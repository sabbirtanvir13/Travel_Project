      ...
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          >
            ...
            <li className="text-black"><Link href="/packages">Packages</Link></li>
            <li className="text-black"><Link href="/about">About</Link></li>
            <li className="text-black"><Link href="/contact">Contact</Link></li>

            {/* Show only when user logged in */}
            {user && (
              <>
                <li className="text-black"><Link href="/addpackages">Add Packages</Link></li>
                <li className="text-black"><Link href="/mypackages">My Packages</Link></li>
              </>
            )}
          </ul>
        </div>
